    ...
    <div className="bg-white/80 backdrop-blur-xl rounded-2xl p-6 shadow-lg border border-emerald-100">
      <div className="flex justify-between items-center mb-6 pb-4 border-b border-emerald-200">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-xl font-bold text-gray-800">{t('filterBy')}</h3>
        </div>
        <button
      ...
      <div className="space-y-5">
        ...
        <div>
          ...
          >
            <label className="text-sm font-semibold text-gray-700">{t('caste')}</label>
        ...
        <div>
          ...
          >
            <label className="text-sm font-semibold text-gray-700">{t('residence')}</label>
        ...
        <div>
          ...
          >
            <label className="text-sm font-semibold text-gray-700">{t('benefitType')}</label>
        ...
        <div>
          <label className="block text-sm font-semibold text-gray-700 mb-2">{t('disabilityPercentage')}</label>
          <select
            className="w-full px-4 py-2.5 bg-white/50 border border-emerald-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent text-gray-700 cursor-pointer"
        ...
        <div>
          ...
          >
            <label className="text-sm font-semibold text-gray-700">{t('employmentStatus')}</label>
